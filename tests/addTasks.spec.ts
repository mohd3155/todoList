...
test.beforeEach(async ({ page }) => {
    await page.goto('https://mohd-todolist.netlify.app/');
});
...
const tasks = [{
    ...
    test("Add a new task and change its status to completed and verify it appears in the completed tasks list",async ({page})=>{
